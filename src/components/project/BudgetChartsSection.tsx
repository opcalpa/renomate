...
const COST_CENTER_I18N: Record<string, string> = {
  demolition: "costCenters.demolition",
  construction: "costCenters.construction",
  electricity: "costCenters.electricity",
  electrical: "costCenters.electricity",
  plumbing: "costCenters.plumbing",
  tiles: "costCenters.tiles",
  tiling: "costCenters.tiles",
  floor: "costCenters.floor",
  flooring: "costCenters.floor",
  paint: "costCenters.paint",
  painting: "costCenters.paint",
  carpentry: "costCenters.carpentry",
  windows_doors: "costCenters.windowsDoors",
  windows: "costCenters.windowsDoors",
  doors: "costCenters.windowsDoors",
  inspection: "costCenters.inspection",
  cleanup: "costCenters.cleanup",
  design: "costCenters.design",
  // Legacy
