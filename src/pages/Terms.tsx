      ...
      <header className="container mx-auto px-4 pt-8 pb-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center">
            <img src="/brand/svg/lockup/horizontal-green.svg" alt="Renofine" className="h-8 w-auto" />
          </div>
      ...
      <main className="flex-1 container mx-auto px-4 py-12">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
            ...
            <p>
              By accessing and using Renofine, you accept and agree to be bound by the terms
              and provision of this agreement.
            </p>

            <h2 className="text-2xl font-semibold text-foreground mt-8 mb-4">2. Use License</h2>
            <p>
              Permission is granted to temporarily use Renofine for personal, non-commercial
            ...
            <p>
              Your use of Renofine is also governed by our Privacy Policy. Please review our
            ...
            <p>
              Renofine reserves the right to modify or replace these Terms at any time. It is
            ...
            <p>
              In no event shall Renofine, nor its directors, employees, partners, agents,
