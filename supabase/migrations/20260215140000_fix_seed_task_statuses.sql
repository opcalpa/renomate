-- Fix seed_demo_project_for_user to use correct status values
-- The constraint allows: 'planned', 'to_do', 'waiting', 'in_progress', 'completed', 'cancelled'
-- The old function was using 'done' which is no longer valid
...
BEGIN
  ...
  VALUES (v_room_id, v_project_id, 'Vardagsrum', 'Stort vardagsrum med parkettgolv', 'to_be_renovated', 2600);
  ...
  v_room_ids := array_append(v_room_ids, v_room_id);
  INSERT INTO rooms (id, project_id, name, description, status, ceiling_height_mm)
  VALUES (v_room_id, v_project_id, 'Sovrum', 'Sovrum med fondvägg', 'to_be_renovated', 2600);
  ...
  v_room_ids := array_append(v_room_ids, v_room_id);
  INSERT INTO rooms (id, project_id, name, description, status, ceiling_height_mm)
  VALUES (v_room_id, v_project_id, 'Kök', 'Kök med nya bänkskivor', 'to_be_renovated', 2600);
  ...
  v_room_ids := array_append(v_room_ids, v_room_id);
  INSERT INTO rooms (id, project_id, name, description, status, ceiling_height_mm)
  VALUES (v_room_id, v_project_id, 'Badrum', 'Badrum med kakel', 'to_be_renovated', 2600);
  ...
  v_room_ids := array_append(v_room_ids, v_room_id);
  INSERT INTO rooms (id, project_id, name, description, status, ceiling_height_mm)
  VALUES (v_room_id, v_project_id, 'Hall', 'Entréhall', 'to_be_renovated', 2600);
  ...
  -- Create tasks with CORRECT status values: 'completed' not 'done'
  ...
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[1], v_task_ids[2], 'Spackel fin (Gyproc)', 5, 'st', 350, 'Byggmax', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[1], v_task_ids[3], 'Väggfärg Beckers Scotte 7', 25, 'liter', 85, 'Colorama', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[1], v_task_ids[3], 'Takfärg Beckers Takfärg', 10, 'liter', 95, 'Colorama', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[2], v_task_ids[4], 'Tapet Boråstapeter Linen', 6, 'rullar', 890, 'Boråstapeter', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[1], v_task_ids[5], 'Golvlack Bona Traffic HD', 5, 'liter', 520, 'Bona', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[3], v_task_ids[6], 'Bänkskiva IKEA Ekbacken', 1, 'st', 8500, 'IKEA', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[3], v_task_ids[6], 'Kakel stänkskydd vit 10x20', 2, 'kvm', 650, 'Kakel Direkt', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[4], v_task_ids[7], 'Kakel vägg vit blank 20x25', 12, 'kvm', 490, 'Bauhaus', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[4], v_task_ids[7], 'Fogmassa grå', 8, 'kg', 65, 'Bauhaus', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, NULL, v_task_ids[8], 'Golvlist vitmålad 12x56mm', 45, 'meter', 89, 'Byggmax', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[1], v_task_ids[8], 'Taklist klassisk 45mm', 25, 'meter', 125, 'Byggmax', p_owner_id);

  INSERT INTO materials (id, project_id, room_id, task_id, name, quantity, unit, price_per_unit, vendor_name, created_by_user_id)
  VALUES (gen_random_uuid(), v_project_id, v_room_ids[3], v_task_ids[9], 'LED-spots inbyggnad 6W', 6, 'st', 299, 'Elgiganten', p_owner_id);
