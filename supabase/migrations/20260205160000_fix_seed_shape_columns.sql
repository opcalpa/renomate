...
-- The app saves/loads shapes using shape_data (JSONB) containing points, name, colors etc.
-- Previous seed versions used non-existent separate columns (name, fill_color, etc.)
-- which caused the INSERT to fail silently, leaving rooms without canvas shapes.
...
BEGIN
  ...
  -- Create materials WITHOUT specifying status - let database use default 'new'
