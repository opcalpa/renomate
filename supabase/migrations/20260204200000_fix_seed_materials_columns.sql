-- Fix the seed function to use correct materials columns
-- materials uses price_per_unit instead of cost
...
BEGIN
  ...
  -- Create materials using correct column names: price_per_unit instead of cost
